...
class TimerView extends StatelessWidget {
  ...
  TextStyle? _getMainTextStyle(BuildContext context) =>
      Theme.of(context).textTheme.displayMedium?.copyWith(
            color: MyColors.white,
            fontWeight: FontWeight.bold,
          );
  
  TextStyle? _getTextStyleForSeconds(BuildContext context) =>
      Theme.of(context).textTheme.displayMedium?.copyWith(
            color: MyColors.fireEngineRed,
            fontWeight: FontWeight.bold,
          );
  
  TextStyle? _getTaskNameTextStyle(BuildContext context) =>
